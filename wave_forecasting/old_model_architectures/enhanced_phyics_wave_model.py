...
class EnhancedPhysicsConfig:
    ...
    hidden_dim: int = 384              # Scaled up from 256
    temporal_hidden_dim: int = 192     # Scaled up from 128
    num_spatial_layers: int = 8        # Scaled up from 6
    num_temporal_layers: int = 3       # Scaled up from 2
    
    # Enhanced attention
    use_spatial_attention: bool = True
    use_temporal_attention: bool = True
    num_attention_heads: int = 12      # Scaled up from 8
    
    # Regularization (slightly reduced for larger model)
    dropout: float = 0.12              # Reduced from 0.15
    spatial_dropout: float = 0.08      # Reduced from 0.1
    ...
    wave_equation_weight: float = 0.3  # NEW: Wave equation constraints
    energy_conservation_weight: float = 0.2  # NEW: Energy conservation
...
def main():
    ...
    config = EnhancedPhysicsConfig(
        ...
        # Enhanced physics
        wave_equation_weight=0.3,
        energy_conservation_weight=0.2,
